...
public class ChartsView {
    ...
    // Retrofit Request
    public void setupPieChart(ArrayList<String> departments, ArrayList<Double> tons, AnyChartView anyChartView) {
    ...
    public void setupColumnChart(ArrayList<String> departments, ArrayList<Double> tons, AnyChartView anyChartView) {
        ...
        cartesian.xAxis(0).title("Departamento");
        cartesian.yAxis(0).title("Toneladas");

        anyChartView.setChart(cartesian);
    }

    public void setup3DBarChart(ArrayList<String> departments, ArrayList<Double> tons, AnyChartView anyChartView) {
        ...
        for (int i = 0; i < departments.size(); i++) {
            data.add(new CustomDataEntry(departments.get(i), tons.get(i)));
        }
